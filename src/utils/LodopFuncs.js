	...
	try {
		...
		if (needCLodop()) {
			...
			if (!LODOP) {
				...
				console.log(
					"打印软件未安装，请返回登录页安装打印软件安装再试！"
				)
				// alert("打印软件未安装，请返回登录页安装打印软件安装再试！")
				return
			} else {
		...
		LODOP.SET_LICENSES(
			"深圳百泰投资控股集团有限公司",
			"7B9CF6AB98538B1DC8672F1C0C0C04F2",
			"深圳百泰投資控股集團有限公司",
			"6FCE53DE8725BAFDC5F1F8225EFC3CF4"
		)
		LODOP.SET_LICENSES(
			"THIRD LICENSE",
			"",
			"Shenzhen BATAR Investment Holding Group Co., Ltd.",
			"951CAF3EC9CC4AEDDFD2BCEC99AFADC9"
		)
		//===========================================================
		return LODOP
	} catch (err) {
